  ...
  return (
    <>
      <div className="flex flex-col items-center md:px-[7rem] md:pt-8 md:pb-[6rem] relative bg-Gray-light-mode-50">
        <div className="w-full flex flex-col items-center gap-6 px-4 py-16 md:p-[6rem] bg-[linear-gradient(to_right_bottom,_#219c4e,_#d9b62e)] shadow-lg md:rounded-3xl text-xl font-normal leading-8 text-Brand-200 text-center">
